...
using ServiceA.Infrastructure.Mapping;
using ServiceA.Persistence;
using ServiceA.Service.Contract;
using ServiceA.Service.Implementation;
using System;
using System.IO;
    ...
    public static class ConfigureServiceContainer
    {
             ...
             IConfiguration configuration, IConfigurationRoot configRoot)
        {
            serviceCollection.AddDbContext<ApplicationDbContext>(options =>
             // options.UseSqlite("Data Source=app.db",builder=>builder.MigrationsAssembly(Assembly.GetExecutingAssembly().GetName().Name))
        ...
        //{
        //    //var assembly = AppDomain.CurrentDomain.Lservicead("ServiceA.Service");
